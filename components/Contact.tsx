    ...
    <section id="contact" className="py-24 px-4 sm:px-6 lg:px-8 bg-background">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-8">
            <div className="space-y-6">
              ...
              <a
                ...
                className="flex items-start gap-4 p-6 rounded-xl border border-border bg-card hover:shadow-lg hover:border-accent/50 transition-all group animate-fade-in-up"
              >
                <Mail className="text-accent flex-shrink-0 mt-1" size={24} />
                <div>
                  <h3 className="font-semibold text-primary mb-1">Email</h3>
                  <p className="text-foreground text-sm">hansinisamrathunga65@gmail.com</p>
                </div>
              </a>

              {/* Phone */}
              <div className="flex items-start gap-4 p-6 rounded-xl border border-border bg-card hover:shadow-lg hover:border-accent/50 transition-all group animate-fade-in-up" style={{ animationDelay: '0.1s' }}>
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-foreground text-sm">Hansini Samarathunga</p>
                </div>
              </a>
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-foreground text-sm">@hansini101</p>
                </div>
              </a>
            </div>
          </div>
          ...
          {/* Contact Form */}
          <div className="bg-card rounded-xl border border-border p-8 hover:shadow-lg transition-all duration-300 animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <input
                  ...
                  required
                  className="w-full px-4 py-2 rounded border border-border bg-background text-foreground placeholder-muted-foreground focus:outline-none focus:border-accent focus:ring-1 focus:ring-accent"
